...
export interface ApiAdAd extends Struct.CollectionTypeSchema {
  collectionName: 'ads';
  info: {
    description: 'Ad placements: card slug, filters, search tags, and list positions';
    displayName: 'Ads';
    pluralName: 'ads';
    singularName: 'ad';
  };
  ...
  attributes: {
    cardListPositionBottom: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    cardListPositionMiddle: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      ...
      Schema.Attribute.DefaultTo<false>;
    cardListPositionTop: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      ...
      Schema.Attribute.DefaultTo<false>;
    cardSlug: Schema.Attribute.Text &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    filterParameters: Schema.Attribute.JSON &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    searchTags: Schema.Attribute.Component<'ads.search-tag', true> &
...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    relatedCards: Schema.Attribute.Text &
      Schema.Attribute.CustomField<'global::credit-card-slugs'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    relatedOffers: Schema.Attribute.Relation<
      'manyToMany',
      'api::shop-offer.shop-offer'
    >;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Contact page content and details';
    displayName: 'Contact';
    pluralName: 'contacts';
...
export interface ApiCreditCardCreditCard extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Credit card slugs managed with external API autocomplete';
  ...
  attributes: {
    cardFaceImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    staticContents: Schema.Attribute.Component<
    ...
    topMetrics1Value: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    topMetrics2Label: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    topMetrics2Value: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    topMetrics3Label: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    topMetrics3Value: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    bestRebateScoresInfo: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    cardListInfo: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    creditCardScoresInfo: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    spiderchartScoresInfo: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHeroCarouselHeroCarousel
  ...
  info: {
    description: 'Marketing hero banners for homepage carousel';
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Home page configuration and featured content';
  ...
  attributes: {
    ...
    featuredBlogPosts: Schema.Attribute.Relation<
      ...
      'api::blog-post.blog-post'
    >;
    featuredCardSlugs: Schema.Attribute.Text &
      Schema.Attribute.CustomField<'global::credit-card-slugs'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    featuredOffers: Schema.Attribute.Relation<
      'oneToMany',
      'api::shop-offer.shop-offer'
    >;
    heroCarousels: Schema.Attribute.Relation<
      'oneToMany',
      'api::hero-carousel.hero-carousel'
    >;
    hotPicksDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    hotPicksTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'Our Hot Picks'>;
    latestPostsTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'Latest Posts'>;
    limitedOffersTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'Limited Shop Offers'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    mostViewedTitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Most Viewed Cards'>;
    publishedAt: Schema.Attribute.DateTime;
    seoDescription: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiMerchantMerchant extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Merchants that can be associated with shop offers';
...
export interface ApiShopOfferCategoryShopOfferCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'shop_offer_categories';
  info: {
    description: 'Labels for shop offers; create entries here to extend the pick list';
    displayName: 'Shop Offer Category';
    pluralName: 'shop-offer-categories';
    singularName: 'shop-offer-category';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::shop-offer-category.shop-offer-category'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiShopOfferShopOffer extends Struct.CollectionTypeSchema {
  collectionName: 'shop_offers';
  info: {
    description: 'Shopping offers and promotions';
    displayName: 'Shop Offer';
    pluralName: 'shop-offers';
    singularName: 'shop-offer';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    categories: Schema.Attribute.Relation<
      ...
      'api::shop-offer-category.shop-offer-category'
    >;
    channel: Schema.Attribute.Enumeration<['online', 'retail', 'all']> &
      Schema.Attribute.DefaultTo<'all'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    creditCardSlug: Schema.Attribute.Text &
      Schema.Attribute.CustomField<'global::credit-card-slugs'>;
    ...
    merchantWebsite: Schema.Attribute.String;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedBlogPosts: Schema.Attribute.Relation<
      'manyToMany',
      'api::blog-post.blog-post'
    >;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
...
export interface ApiStaticPageStaticPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Static pages like About, Terms, Privacy Policy, etc.';
  ...
  attributes: {
    ...
    pageType: Schema.Attribute.Enumeration<
      ['about', 'terms', 'privacy', 'contact', 'faq', 'other']
    > &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::shop-offer-category.shop-offer-category': ApiShopOfferCategoryShopOfferCategory;
      'api::shop-offer.shop-offer': ApiShopOfferShopOffer;
